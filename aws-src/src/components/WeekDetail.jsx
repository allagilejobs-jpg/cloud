        ...
        {["overview", "prompts", "labs", ...(week.project ? ["project"] : []), "resources"].map(t => (
          <button 
            ...
            style={{
              ...
              background: activeTab === t ? "#FF9900" : "var(--card-bg)",
              color: activeTab === t ? "#0a0e1a" : "var(--text-muted)",
              ...
              <div key={i} className="cd" style={{ padding: 16, animation: `slideIn .3s ease ${i * .03}s both` }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
                  ...
                  <button 
                    ...
                    style={{ padding: "4px 10px", background: copiedId === pid ? "#22c55e" : "#FF9900", color: copiedId === pid ? "#fff" : "#0a0e1a", fontSize: 11 }}
                  >
              ...
              <>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
                  ...
                  <button 
                    ...
                    style={{ padding: "4px 10px", background: copiedId === week.project.id ? "#22c55e" : "#FF9900", color: copiedId === week.project.id ? "#fff" : "#0a0e1a", fontSize: 11 }}
                  >
