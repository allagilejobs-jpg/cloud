...
const STORAGE_KEY = "project-scheduling-mastery-v1";
const THEME_KEY = "project-scheduling-theme";
...
function App() {
  ...
  const exportProgress = () => {
    const data = { progress, exportedAt: new Date().toISOString(), app: "project-scheduling-mastery-v1" };
    const blob = new Blob([JSON.stringify(data, null, 2)], { type: "application/json" });
    const url = URL.createObjectURL(blob);
    const a = document.createElement("a");
    a.href = url;
    a.download = `project-scheduling-progress-${new Date().toISOString().split("T")[0]}.json`;
    a.click();
